package com.mediafire.sdk.api.clients.contact;
...
public class ContactClientTest extends TestCase {
    ...
    public void testAddUrl() throws Exception {
        ...
        DummyHttp.DummyPOSTResponse dummyPOSTResponse = (DummyHttp.DummyPOSTResponse) result.getResponse();

        String actual = dummyPOSTResponse.getOriginalUrl();
        String expected = "https://www.mediafire.com/api/" + ApiVersion.VERSION_1_2 + "/contact/add.php";
    ...
    public void testDeleteUrl() throws Exception {
        ...
        String actual = dummyPOSTResponse.getOriginalUrl();
        String expected = "https://www.mediafire.com/api/" + ApiVersion.VERSION_1_2 + "/contact/delete.php";
