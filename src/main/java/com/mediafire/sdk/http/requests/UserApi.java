 ...
 */
public class UserApi extends AbstractApiRequest {
    /**
     ...
     */
    public UserApi(MFConfiguration mfConfiguration, MFTokenFarmCallback mfTokenFarmCallback) {
        super(mfConfiguration, mfTokenFarmCallback);
    }

    public void getInfo() {
        MFRequest mfRequest = new MFRequest(MFHost.LIVE_HTTP, MFApi.USER_GET_INFO);
