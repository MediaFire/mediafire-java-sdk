...
import com.mediafire.sdk.clients.DummyActionTokenManager;
...
public class UploadClientTest extends TestCase {
    ...
    public void testCheckSingleParamPayload() throws Exception {
        ...
        String expected = "response_format=json&filename=some_file.ext&resumable=yes&session_token=verylongsessiontokenstring123456789abcdefghijklmnopqrstuvwxyz";
    ...
    public void testCheckMultiParamPayload() throws Exception {
        ...
        DummyHttpWorker.DummyPOSTResponse response = (DummyHttpWorker.DummyPOSTResponse) result.getResponse();
        String actual = new String(response.getOriginalPayload());
        String expected = "response_format=json&filename=some_file.ext&hash=abcdefg1234567890&resumable=yes&session_token=verylongsessiontokenstring123456789abcdefghijklmnopqrstuvwxyz";
    ...
    public void testInstantBaseParamsPayload() throws Exception {
        ...
        DummyHttpWorker.DummyPOSTResponse response = (DummyHttpWorker.DummyPOSTResponse) result.getResponse();
        String actual = new String(response.getOriginalPayload());
        String expected = "response_format=json&hash=abcdefg1234567890&size=1234567&session_token=verylongsessiontokenstring123456789abcdefghijklmnopqrstuvwxyz";
    ...
    public void testInstantMultiParamsPayload() throws Exception {
        ...
        DummyHttpWorker.DummyPOSTResponse response = (DummyHttpWorker.DummyPOSTResponse) result.getResponse();
        String actual = new String(response.getOriginalPayload());
        String expected = "response_format=json&hash=abcdefg1234567890&size=1234567&action_on_duplicate=keep&version_control=create_patches&session_token=verylongsessiontokenstring123456789abcdefghijklmnopqrstuvwxyz";
    ...
    public void testResumableNoArgParamUrl() throws Exception {
        ...
        DummyHttpWorker.DummyPOSTResponse response = (DummyHttpWorker.DummyPOSTResponse) result.getResponse();
        String actual = response.getOriginalUrl();
        String expected = "https://www.mediafire.com/api/1.2/upload/resumable.php?response_format=json&session_token=verylongsessiontokenstring123456789abcdefghijklmnopqrstuvwxyz";
    ...
    public void testResumableSingleParamUrl() throws Exception {
        ...
        DummyHttpWorker.DummyPOSTResponse response = (DummyHttpWorker.DummyPOSTResponse) result.getResponse();
        String actual = response.getOriginalUrl();
        String expected = "https://www.mediafire.com/api/1.2/upload/resumable.php?response_format=json&action_on_duplicate=keep&session_token=verylongsessiontokenstring123456789abcdefghijklmnopqrstuvwxyz";
    ...
    public void testResumableMultiParamUrl() throws Exception {
        ...
        DummyHttpWorker.DummyPOSTResponse response = (DummyHttpWorker.DummyPOSTResponse) result.getResponse();
        String actual = response.getOriginalUrl();
        String expected = "https://www.mediafire.com/api/1.2/upload/resumable.php?response_format=json&folder_key=folder_keyabc1234&action_on_duplicate=keep&version_control=none&session_token=verylongsessiontokenstring123456789abcdefghijklmnopqrstuvwxyz";
