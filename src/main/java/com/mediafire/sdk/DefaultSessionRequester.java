...
public class DefaultSessionRequester implements MFSessionRequester {
    ...
    private final com.mediafire.sdk.config.MFHttpRequester http;
    ...
    public DefaultSessionRequester(MFCredentials credentials, String appId, String apiKey, com.mediafire.sdk.config.MFHttpRequester http, MFStore<SessionToken> sessionStore) {
    ...
    public DefaultSessionRequester(MFCredentials credentials, String appId, com.mediafire.sdk.config.MFHttpRequester http, MFStore<SessionToken> sessionStore) {
