...
public class FileApi {
     ...
     * @throws  if there was an api error
     */
    public static <T extends ApiResponse> T getVersion(MediaFireClient mediaFire, LinkedHashMap<String, Object> requestParams, String apiVersion, Class<T> classOfT) throws MediaFireException {
     ...
     * @throws  if there was an api error
     */
    public static <T extends ApiResponse> T getLinks(MediaFireClient mediaFire, LinkedHashMap<String, Object> requestParams, String apiVersion, Class<T> classOfT) throws MediaFireException {
