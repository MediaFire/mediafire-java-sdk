...
public class BaseClientHelperTest extends TestCase {
    ...
    public void testMakeSignatureForApiRequestUsingUrl() throws Exception {
//        Request request = new Request("http://www.mediafire.com/api/user/get_info.php?");
//        baseClientHelper.setup(request);
//
...
//        assertEquals(expected, actual);
    ...
    public void testMakeSignatureForApiRequestNoParamsUsingRequestBuilder() throws Exception {
        SessionToken sessionToken = sessionTokenManagerInterface.borrowSessionToken();
