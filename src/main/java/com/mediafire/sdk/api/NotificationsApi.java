...
public class NotificationsApi {
     ...
     */
    public static <T extends ApiResponse> T  getCache(MediaFireClient mediaFire, LinkedHashMap<String, Object> requestParams, String apiVersion, Class<T> classOfT) throws MediaFireException {
     ...
     * @throws  if there was an api error
     */
    public static <T extends ApiResponse> T  peekCache(MediaFireClient mediaFire, LinkedHashMap<String, Object> requestParams, String apiVersion, Class<T> classOfT) throws MediaFireException {
     ...
     * @throws  if there was an api error
     */
    public static <T extends ApiResponse> T  sendMessage(MediaFireClient mediaFire, LinkedHashMap<String, Object> requestParams, String apiVersion, Class<T> classOfT) throws MediaFireException {
     ...
     * @throws  if there was an api error
     */
    public static <T extends ApiResponse> T  sendNotification(MediaFireClient mediaFire, LinkedHashMap<String, Object> requestParams, String apiVersion, Class<T> classOfT) throws MediaFireException {
